...
namespace Havtorn
{
	...
	*/
	...
	void CAssetBrowserWindow::ImportOptionsAnimation()
	{
		...
		SAssetPickResult result = GUI::AssetPickerFilter("Skeletal Rig", "Skeletal Mesh", assetPickerThumbnail, "Assets/Tests", columnCount, Manager->GetAssetInspectFunction(), EAssetType::SkeletalMesh);
