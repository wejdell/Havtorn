...
namespace Havtorn
{
	...
	bool CFullscreenRenderer::Init(CGraphicsFramework* framework) 
	{
		...
		filepaths[STATIC_U64(EFullscreenShader::BrokenScreenEffect)] = "Shaders/FullscreenBrokenScreenEffect_PS.cso";
...
#pragma endregion
	...
	{
		FullscreenData.Resolution = GEngine::GetWindowHandler()->GetResolution();
