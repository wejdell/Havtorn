...
namespace Havtorn
{
	struct ENGINE_API SDirectionalLightComponentEditorContext : public SComponentEditorContext
	{
		...
		virtual const char* GetComponentName() const override { return "Directional Light"; };
		static SDirectionalLightComponentEditorContext Context;
	};
}