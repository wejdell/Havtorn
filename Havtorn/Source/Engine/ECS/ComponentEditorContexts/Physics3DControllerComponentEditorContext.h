...
namespace Havtorn
{
	struct ENGINE_API SPhysics3DControllerComponentEditorContext : public SComponentEditorContext
	{
		...
		virtual const char* GetComponentName() const override { return "Physics 3D Controller"; };
		static SPhysics3DControllerComponentEditorContext Context;
	};
}
