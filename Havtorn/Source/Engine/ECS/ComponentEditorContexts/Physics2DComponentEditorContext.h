...
namespace Havtorn
{
	struct ENGINE_API SPhysics2DComponentEditorContext : public SComponentEditorContext
	{
		...
		virtual const char* GetComponentName() const override { return "Physics 2D"; };
		static SPhysics2DComponentEditorContext Context;
	};
}
