...
namespace Havtorn
{
	struct ENGINE_API SSequencerComponentEditorContext : public SComponentEditorContext
	{
		...
		virtual const char* GetComponentName() const override { return "Sequencer"; };
		static SSequencerComponentEditorContext Context;
	};
}
