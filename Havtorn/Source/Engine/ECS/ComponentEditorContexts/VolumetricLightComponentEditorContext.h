...
namespace Havtorn
{
	struct ENGINE_API SVolumetricLightComponentEditorContext : public SComponentEditorContext
	{
		...
		virtual const char* GetComponentName() const override { return "Volumetric Light"; };
		static SVolumetricLightComponentEditorContext Context;
	};
}
