...
namespace Havtorn
{
	struct ENGINE_API SSpriteAnimatorGraphComponentEditorContext : public SComponentEditorContext
	{
		...
		virtual const char* GetComponentName() const override { return "Sprite Animator Graph"; };
		static SSpriteAnimatorGraphComponentEditorContext Context;
	};
}
