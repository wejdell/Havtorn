...
namespace Havtorn
{
	struct ENGINE_API SSpotLightComponentEditorContext : public SComponentEditorContext
	{
		...
		virtual const char* GetComponentName() const override { return "Spotlight"; };
		static SSpotLightComponentEditorContext Context;
	};
}
