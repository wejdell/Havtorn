...
namespace Havtorn
{
	struct ENGINE_API SSpriteComponentEditorContext : public SComponentEditorContext
	{
		...
		virtual const char* GetComponentName() const override { return "Sprite"; };
		static SSpriteComponentEditorContext Context;
	};
}
