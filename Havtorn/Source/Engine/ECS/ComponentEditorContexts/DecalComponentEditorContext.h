...
namespace Havtorn
{
	struct ENGINE_API SDecalComponentEditorContext : public SComponentEditorContext
	{
		...
		virtual const char* GetComponentName() const override { return "Decal"; };
		static SDecalComponentEditorContext Context;
	};
}
