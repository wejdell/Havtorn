...
namespace Havtorn
{
    SComponentViewResult SPhysics2DComponentView::View(const SEntity& entityOwner, CScene* scene)
    {
		if (!ImGui::UUtils::TryOpenComponentView("Physics2D"))
			return {};
		...
		ImGui::SliderInt("Shape Type", &shapeTypeIndex, 0, 3, shapeTypeNames[shapeTypeIndex]);
		...
		ImGui::DragFloat2("Shape Local Offset", localOffset, ImGui::UUtils::SliderSpeed);
		...
		ImGui::Checkbox("Constrain Rotation", &physicsComponent->ConstrainRotation);
