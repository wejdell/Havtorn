...
namespace ak
{
	namespace soundengine
	{
		...
		/*! Sets the value of a Game Parameter for real-time parameter control. See <tt>AK::SoundEngine::SetRTPCValue</tt>. */
	...
	namespace wwise
	{
		...
		namespace core
		{
			...
			namespace object
			{
				...
				static const char* structureChanged = "ak.wwise.core.object.structureChanged";
			}
			...
			namespace profiler
			{
				...
				/*! Moves the user time cursor of the profiler to a specific position (first, last, next, previous), and returns the new time. This sets the cursor position in the profiler views. */
				static const char* moveCursor = "ak.wwise.core.profiler.moveCursor";
			...
			namespace workUnit
			{
				...
				static const char* load = "ak.wwise.core.workUnit.load";
				...
				static const char* unload = "ak.wwise.core.workUnit.unload";
			}
		}
		namespace debug
		{
		...
		namespace ui
		{
			...
			namespace layout
			{
				...
				static const char* closeView = "ak.wwise.ui.layout.closeView";
		...
		namespace waapi
		{
			...
			/*! Retrieves the JSON schema of a Waapi Function or Topic URI. */
