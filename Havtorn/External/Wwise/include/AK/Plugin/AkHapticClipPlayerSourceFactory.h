...
#pragma once
/// \file
/// Registers the Haptic Clip Player plugin automatically.
...
/// <br><b>Wwise plugin name:</b> Haptic Clip Player
/// <br><b>Library file:</b> AkHapticClipPlayerSource.lib


AK_STATIC_LINK_PLUGIN(AkHapticClipPlayerSource)
