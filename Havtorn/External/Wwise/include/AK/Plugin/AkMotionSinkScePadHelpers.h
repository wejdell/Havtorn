...
#include <windef.h> // required for pad_windows_static.h compilation
#include <pad.h>
	...
	{ \
		...
		{ \
			AkMotionInitializeScePadFunctions(\
				...
				(AK::_akmotionPadGetControllerBusType)scePadGetControllerBusType); \
		} \
	...
	{ \
		...
		{ \
			typedef int(*_akmotionPadInitFunc)( \
				...
				AK::_akmotionPadGetControllerBusType in_pPadGetControllerBusType); \
