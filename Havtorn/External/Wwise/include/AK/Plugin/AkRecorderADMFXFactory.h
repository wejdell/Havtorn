...
#pragma once
/// \file
/// Registers the Recorder (ADM) plugin automatically.
...
/// <br><b>Wwise plugin name:</b> Recorder (ADM)
/// <br><b>Library file:</b> AkRecorderADMFX.lib

AK_STATIC_LINK_PLUGIN(AkRecorderADMFX)
